...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "gf") >= 0 || findKeyword(statement, "bf") >= 0)
		{
			response = "Tell me more about your significant other.";
		}
		else if (findKeyword(statement, "Yes") >= 0)
		{
			response = "Good.";
		}
		else if (findKeyword(statement, "did it") >= 0)
		{
			response = "Good job!";
		}
		else if (findKeyword(statement, "sad") >= 0)
		{
			response = "It'll be okay.";
		}
		else if (findKeyword(statement, "no") >= 0)
		{
			response = "Why so negative?";
